...
impl<'l> Parse<'l> for Ident<'l> {
	fn parse(input: &mut TokenStream<'l>) -> PResult<Self, ParserError<'l>> {
		trace("Ident", |input: &mut TokenStream<'l>| {
...
impl<'l> Parse<'l> for Expression<'l> {
	fn parse(input: &mut TokenStream<'l>) -> PResult<Self, ParserError<'l>> {
		trace("Expression", |input: &mut TokenStream<'l>| {
...
impl<'l> Parse<'l> for NewStruct<'l> {
	fn parse(input: &mut TokenStream<'l>) -> PResult<Self, ParserError<'l>> {
		trace("NewStruct", |input: &mut TokenStream<'l>| {
			let start = input.start_char();
			let id = (Token::New, Ident::parse).parse_next(input)?.1;
...
impl<'l> Parse<'l> for Type<'l> {
	fn parse(input: &mut TokenStream<'l>) -> PResult<Self, ParserError<'l>> {
		trace("Type", |input: &mut TokenStream<'l>| {
			let start = input.start_char();
			let ty = alt((
...
impl<'l> Parse<'l> for Block<'l> {
	fn parse(input: &mut TokenStream<'l>) -> PResult<Self, ParserError<'l>> {
		trace("Block", |input: &mut TokenStream<'l>| {
			let start = input.start_char();
...
impl<'l> Parse<'l> for VarDecl<'l> {
	fn parse(input: &mut TokenStream<'l>) -> PResult<Self, ParserError<'l>> {
		trace("VarDecl", |input: &mut TokenStream<'l>| {
			...
			let (ty, value) = alt((
				(Token::Equal, required(Expression::parse)).map(|(_, val)| (None, val)),
				(
					required(Token::Colon),
					Type::parse,
					Token::Equal,
...
impl<'l> Parse<'l> for SymbolDeclaration<'l> {
	fn parse(input: &mut TokenStream<'l>) -> PResult<Self, ParserError<'l>> {
		trace("SymbolDeclaration", |input: &mut TokenStream<'l>| {
			let start = input.start_char();
...
impl<'l> Parse<'l> for Struct<'l> {
	fn parse(input: &mut TokenStream<'l>) -> PResult<Self, ParserError<'l>> {
		trace("TokenStream", |input: &mut TokenStream<'l>| {
...
impl<'l> Parse<'l> for StructMember<'l> {
	fn parse(input: &mut TokenStream<'l>) -> PResult<Self, ParserError<'l>> {
		trace("StructMember", |input: &mut TokenStream<'l>| {
			match (Ident::parse, Token::Colon, required(Type::parse)).parse_next(input) {
...
impl<'l> Parse<'l> for Function<'l> {
	fn parse(input: &mut TokenStream<'l>) -> PResult<Self, ParserError<'l>> {
		trace("Function", |input: &mut TokenStream<'l>| {
...
impl<'l> Parse<'l> for CompilationUnit<'l> {
	fn parse(input: &mut TokenStream<'l>) -> PResult<Self, ParserError<'l>> {
		trace("CompilationUnit", |input: &mut TokenStream<'l>| {
...
{
	trace("list", move |input: &mut TokenStream<'l>| {
		let mut vec = vec![];
		loop {
...
impl<'l> Parser<TokenStream<'l>, &'l TokenData<'l>, ParserError<'l>> for Token<'l> {
	fn parse_next(
		...
		let trace_name = format!("Token::{:?}", self);
		#[cfg(not(feature = "debug_parser"))]
		let trace_name = "Token";

		trace(trace_name, |input: &mut TokenStream<'l>| {
			let checkpoint = input.checkpoint();
			match input.next_token() {
